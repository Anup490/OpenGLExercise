...
namespace ExerciseCamera
{
	...
	int problem1()
	{
		...
		while (window.should_stay())
		{
			...
			update_camera_vectors_prob_1(window, camera_pos, camera_front, camera_up, delta_time);
	...
	int problem2()
	{
		...
		const char* window_title = "OpenGLExerciseCamera 2";
		Window window(window_title);
		VertexBufferObject VBO(square_vertices, sizeof(square_vertices));
		ShaderProgram shader("exercisecamera.vert", "exercisecamera.frag");
		shader.set_int_uniform("tex0", 0);
	...
	void update_camera_vectors_prob_1(Window& window, glm::vec3& camera_pos, glm::vec3& camera_front, glm::vec3& camera_up, float& current_frame)
	{
	...
	void update_camera_vectors_prob_2(Window& window, glm::vec3& camera_pos, glm::vec3& camera_front, glm::vec3& camera_up, float& current_frame)
	{
		const float camera_speed = 2.5f * current_frame;
		if (window.has_pressed(GLFW_KEY_W))
			camera_pos += camera_speed * camera_front;
