...
namespace ExerciseLightingMaps
{
	int problem1()
	{
		...
		const char* window_title = "OpenGLLightingMaps 1";
		Window window(window_title);

		VertexBufferObject VBO(square_vertices, sizeof(square_vertices));
		ShaderProgram shader("exerciselightingmaps1.vert", "exerciselightingmaps1.frag");
	...
	int problem2()
	{
		...
		const char* window_title = "OpenGLLightingMaps 2";
		Window window(window_title);

		VertexBufferObject VBO(square_vertices, sizeof(square_vertices));
		ShaderProgram shader("exerciselightingmaps2.vert", "exerciselightingmaps2.frag");
	...
	int problem3()
	{
		...
		const char* window_title = "OpenGLLightingMaps 3";
		Window window(window_title);

		VertexBufferObject VBO(square_vertices, sizeof(square_vertices));
		ShaderProgram shader("exerciselightingmaps3.vert", "exerciselightingmaps3.frag");
		...
		Texture texturediff("containerdiff.png", GL_TEXTURE0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_NEAREST, GL_RGBA);
		Texture texturespec("containerspeccolor.png", GL_TEXTURE1, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_NEAREST, GL_RGBA);
	...
	int problem4()
	{
		...
		const char* window_title = "OpenGLLightingMaps 4";
		Window window(window_title);

		VertexBufferObject VBO(square_vertices, sizeof(square_vertices));
		ShaderProgram shader("exerciselightingmaps4.vert", "exerciselightingmaps4.frag");
		...
		Texture texturediff("containerdiff.png", GL_TEXTURE0, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_NEAREST, GL_RGBA);
		Texture texturespec("containerspec.png", GL_TEXTURE1, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_NEAREST, GL_RGBA);
		Texture textureemission("containeremission.png", GL_TEXTURE2, GL_CLAMP_TO_EDGE, GL_CLAMP_TO_EDGE, GL_LINEAR, GL_NEAREST, GL_RGB);
		...
		shader.set_int_uniform("material.diffuse", 0);
		shader.set_int_uniform("material.specular", 1);
		shader.set_int_uniform("material.emission", 2);
		shader.set_float_uniform("material.shininess", 32.0f);
