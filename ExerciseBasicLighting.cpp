...
namespace ExerciseBasicLighting
{
	...
	int problem2()
	{
		...
		const char* window_title = "OpenGLExerciseBasicLighting 2";
		Window window(window_title);

		VertexBufferObject VBO(square_vertices, sizeof(square_vertices));
		ShaderProgram shader("exercisebasiclighting2.vert", "exercisebasiclighting2.frag");
	...
	int problem3()
	{
		...
		const char* window_title = "OpenGLExerciseBasicLighting 3";
		Window window(window_title);

		VertexBufferObject VBO(square_vertices, sizeof(square_vertices));
		ShaderProgram shader("exercisebasiclighting3.vert", "exercisebasiclighting3.frag");
	...
	int problem4()
	{
		...
		const char* window_title = "OpenGLExerciseBasicLighting 4";
		Window window(window_title);

		VertexBufferObject VBO(square_vertices, sizeof(square_vertices));
		ShaderProgram shader("exercisebasiclighting4.vert", "exercisebasiclighting4.frag");
